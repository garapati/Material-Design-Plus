// Generated on 2015-02-11 using generator-jade 0.8.1
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      jade: {
        files: '<%= folders.app %>/library/**/*.jade',
        tasks: ['jade']
      }
    },
    connect: {
    ...
    jade: {
      html: {
        ...
        options: {
          client: false,
          pretty: true,
          basedir: '<%= folders.app %>/library',
          data: function(dest, src) {

            var page = src[0].replace(/app\/library\/(.*)\/index.jade/, '$1');
